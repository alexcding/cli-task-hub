...
const PR_FIELDS = 'number,title,state,url,headRefName,baseRefName,mergedAt,author,labels,body,createdAt,updatedAt,isDraft,reviewRequests,reviewDecision';
...
module.exports = { gh, getPRs, getCurrentUser, reviewRequestedAt, categoryOf, extractJiraKeys, parseRepo, gitRemoteRepo, worktreeForBranch, worktreeForJiraKey, gitDiff, gitCommit, gitPush, gitDiscard, summarizeCI };
