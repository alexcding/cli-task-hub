...
def main():
    ...
    fingerprint = hashlib.sha256(lock_bytes + native_patch.read_bytes() + swift_patch.read_bytes()).hexdigest()
    ...
    if needs_preparation:
        ...
        for directory, patch in [(source, native_patch), (package, swift_patch)]:
