...
@Test func diffPageAssetsServeOnlyTheBundledPage() {
    ...
    for name in ["DiffPage.html", "DiffPage.css", "DiffPage.js", "DiffParse.mjs", "DiffHighlight.mjs"] {
        let asset = DiffPageAssets.data(for: URL(string: "taskhub-diff://page/\(name)")!)
    ...
    #expect(DiffPageAssets.data(for: URL(string: "taskhub-diff://page/DiffPage.js")!)?.1 == "text/javascript")
    #expect(DiffPageAssets.data(for: URL(string: "taskhub-diff://page/../Info.plist")!) == nil)
    #expect(DiffPageAssets.data(for: URL(string: "taskhub-diff://other/DiffPage.html")!) == nil)
    #expect(DiffPageAssets.data(for: URL(string: "taskhub-diff://page/sub/DiffPage.html")!) == nil)
}
