...
public enum TerminalStressHarness {
    @MainActor public static func run(seconds: Double, root: URL, reportURL: URL, helperURL: URL? = nil) async throws -> URL {
        ...
        let config = PtydConfiguration(executable: helperURL ?? root.appendingPathComponent("crates/taskhub-ptyd/target/debug/taskhub-ptyd"),
        ...
        do {
            for index in 0..<10 {
                ...
                window.title = "TaskHub isolated terminal stress"
