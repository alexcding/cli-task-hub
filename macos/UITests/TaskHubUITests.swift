...
final class TaskHubUITests: XCTestCase {
    ...
    func testNativeDeepLinksDeferStartupAndPreserveOpenDraft() async throws {
        ...
        XCTAssertTrue(app.radioButtons["Appearance"].waitForExistence(timeout: 5))
        ...
        try await deliver("taskhub://app/projects/\(projectID)/settings")
        ...
        try await deliver("taskhub://app/activity")
    ...
    func testNativeFontPreferencesAndCodeSizeShortcuts() throws {
        ...
        XCTAssertFalse(app.staticTexts["Code and diffs size: 12"].exists, "The code font stays on Appearance")
        app.radioButtons["Appearance"].click()
    ...
    func testNativeSettingsSaveRevertAndMenuNavigation() throws {
        ...
        XCTAssertTrue(app.outlines["workspace-sidebar"].waitForExistence(timeout: 10))
        app.typeKey(",", modifierFlags: .command)
        XCTAssertTrue(app.radioButtons["CLIs"].waitForExistence(timeout: 5))
        app.radioButtons["CLIs"].click()
