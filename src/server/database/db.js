...
module.exports = {
  ...
  getPRScopeSnapshot: datadb.getPRScopeSnapshot,
  setPRScopeSnapshot: datadb.setPRScopeSnapshot,
  prScopeIdentity: datadb.prScopeIdentity,
  prScopeGeneration: datadb.prScopeGeneration,
