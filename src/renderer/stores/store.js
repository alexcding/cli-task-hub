...
export const state = {
  ...
  tabs: [],            // { id, kind:'github'|'jira'|'web', title, url, wv, loaded, started, repo, branch, jiraKey, category, termId }
  activeTabId: null,
  ...
  tasks: [],           // durable tasks (services/tasks.js) — { id, projectId, workspace, worktree, branch, title, kind, url, jiraKey, cli, sessionId }
